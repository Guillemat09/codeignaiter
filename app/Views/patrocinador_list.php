...
-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<form method="get" action="<?= base_url('patrocinadores') ?>">
														...
														<div class="mb-10">
															...
															<input type="text" name="contacto" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="contacto" value="<?= isset($filters['contacto']) ? esc($filters['contacto']) : '' ?>" />
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<th class="min-w-125px">
                                        <a href="<?= base_url('patrocinadores?sort=descripcion&direction=' . ($sort == 'descripcion' && $direction == 'ASC' ? 'DESC' : 'ASC')) ?>">
                                            Descripción
									...
									<th class="min-w-125px">
                                        <a href="<?= base_url('patrocinadores?sort=contacto&direction=' . ($sort == 'contacto' && $direction == 'ASC' ? 'DESC' : 'ASC')) ?>">
                                            Contacto
                                            <?php if ($sort == 'contacto'): ?>
                                                <span class="svg-icon svg-icon-5 m-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        <path d="<?= $direction == 'ASC' ? 'M12 2L7 12h10L12 2z' : 'M12 22l5-10H7l5 10z' ?>" fill="black" />
                                                    </svg>
												...
												<?php foreach ($patrocinadores as $patrocinador): ?>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('patrocinadores/save/' . $patrocinador['id']) ?>" class="menu-link px-3">Editar</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
		...
		<!--end::Javascript-->
		<script>
			document.getElementById("busquedaPatrocinador").addEventListener("keypress", function(event){
				if(event.keyCode == 13){
