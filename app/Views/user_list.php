...
<!--end::Container-->
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<input type="text" name="id" id="busquedaUser" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Busqueda " />
												</form>
											</div>
											<!--end::Search-->
										</div>
    ...
    <div>
        <span><?= count($users) ?> de <?= $pager->getTotal() ?> registros</span>
    </div>
