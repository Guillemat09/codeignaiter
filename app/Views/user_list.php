...
-->
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<form method="get" action="<?= base_url('users') ?>" id="formulariobusqueda">
												<input type="text" name="id" id="busquedaUser" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Busqueda x" />
												</form>
											</div>
											<!--end::Search-->
										</div>
                ...
                <div class="modal-header">
                 <h2 class="fw-bolder">Exportar Usuarios</h2>
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<?php foreach ($users as $user): ?>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1"><?= esc($user['name']) ?></a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('users/save/' . $user['id']) ?>" class="menu-link px-3">Editar</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
    ...
    <!-- DataTables JS -->
		...
		<!--end::Javascript-->
		<script>
			document.getElementById("busquedaUser").addEventListener("keypress", function(event){
				if(event.keyCode == 13){
