								...
								<div class="card">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											<!--begin::Search-->
											<div class="d-flex flex-column flex-md-row align-items-md-center position-relative my-3 w-100">
												...
												<!--end::Svg Icon-->
												<input type="text" class="form-control form-control-solid w-100 w-md-250px ps-14" placeholder="Buscar festival" />
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												...
												<?php foreach ($festivales as $festival): ?>
													...
													<tr class="<?= $festival['is_active'] ? '' : 'text-danger' ?>">
														...
														<td><div class="w-100 text-truncate" style="max-width: 150px;"><?= (new DateTime ($festival['fecha_creacion']))-> format('d/m/Y') ?></div></td>
														<!--begin::Joined-->
														<!--begin::Action=-->
														<td class="text-end">
														<?php if (session()->get('role')['nombre'] == "admin"): ?>
