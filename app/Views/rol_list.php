...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="margin-top: -200px;">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<form method="get" action="<?= base_url('roles') ?>" id="formulariobusqueda">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Svg Icon-->Añadir Roles </button>
												<!--end::Add user-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
															<!--begin::Form-->
															<form action="<?= base_url('roles/save' . (isset($rol) ? '/' . $rol['id'] : '')) ?>" method="post">
																<!--begin::Scroll-->
                                        ...
                                        <a href="<?= base_url('roles?sort=nombre&order=' . ($sort == 'nombre' && $order == 'ASC' ? 'DESC' : 'ASC')) ?>">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<?php foreach ($roles as $rol): ?>
													...
													<!--begin::Last login=-->
                                                    <td>
														<div class="badge badge-light fw-bolder"><?= esc($rol['nombre']) ?></div>
													</td>
													<!--begin::Joined-->
													<!--begin::Action=-->
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('roles/save/' . $rol['id']) ?>" class="menu-link px-3">Editar</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('roles/delete/' . $rol['id']) ?>" class="menu-link px-3" data-kt-users-table-filter="delete_row">Eliminar</a>
															</div>
    ...
    ...
		...
		<script>
			...
			window.location.href = "<?= base_url('export/csv/roles') ?>";
		});
