											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<form method="get" action="<?= base_url('entradas') ?>">
														...
														<!--begin::Actions-->
														<div class="d-flex justify-content-end">
															<a href=" <?= base_url("/entradas") ?>" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6">Resetear</a>
												...
												<!--end::Export-->
												<!--begin::Add user-->
												<a href="<?= base_url('entradas/save') ?>" class="btn btn-primary">
												...
												<!--end::Svg Icon-->Añadir Entradas </a>
												<!--end::Add user-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
