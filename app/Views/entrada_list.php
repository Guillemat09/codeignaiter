...
<!--end::Logo-->
					...
					<div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
						<a href="../../demo1/dist/documentation/getting-started.html" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
							...
							<span class="btn-label"><?= esc($name ?? 'Prueba') ?> <br> <?= esc($rol ?? 'admin') ?></span>
...
-->
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<form method="get" action="<?= base_url('entradas') ?>" id="formulariobusqueda">
												<input type="text" name="tipo_entrada" id="busquedaEntrada" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Busqueda" />
												</form>
											</div>
											<!--end::Search-->
										</div>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<form method="get" action="<?= base_url('entradas') ?>">
														...
														<div class="mb-10">
															...
															<input type="text" name="tipo_entrada" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="tipo_entrada" value="<?= isset($filters['tipo_entrada']) ? esc($filters['tipo_entrada']) : '' ?>" />

														</div>
														<!--end::Input group-->
														<div class="mb-10">
															<label class="form-label fs-6 fw-bold">Precio:</label>
														
															<input type="text" name="precio" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="precio" value="<?= isset($filters['precio']) ? esc($filters['precio']) : '' ?>" />
												...
												<!--end::Svg Icon-->Añadir Entradas </button>
												<!--end::Add user-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
                ...
                <form id="export-form">
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" id="export-excel-btn" class="btn btn-primary">Exportar</button>
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-header" id="kt_modal_add_user_header">
															<!--begin::Modal title-->
															<h2 class="fw-bolder">Añadir Entrada</h2>
															<!--end::Modal title-->
															<!--begin::Close-->
														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
															<!--begin::Form-->
															<form action="<?= base_url('entradas/save' . (isset($entrada) ? '/' . $entrada['id'] : '')) ?>" method="post">
																<!--begin::Scroll-->
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="id" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="id de la entrada" value="" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		<label class="required fw-bold fs-6 mb-2">Tipo de entrada</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="tipo_entrada" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Tipo de entrada" value="" />
																		<!--end::Input-->
																	</div>
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="precio" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="precio" value="" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
									...
									<th class="min-w-125px">
                                        <a href="<?= base_url('entradas?sort=precio&direction=' . ($sort == 'precio' && $direction == 'ASC' ? 'DESC' : 'ASC')) ?>">
                                            Precio
                                            <?php if ($sort == 'precio'): ?>
                                                <span class="svg-icon svg-icon-5 m-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												...
												<?php foreach ($entradas as $entrada): ?>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('entradas/save/' . $entrada['id']) ?>" class="menu-link px-3">Editar</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
    ...
    ...
		...
		<!--end::Javascript-->
		<script>
			document.getElementById("busquedaEntrada").addEventListener("keypress", function(event){
				if(event.keyCode == 13){
