					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="<?= base_url('/login') ?>" method="post">
							...
							<div class="text-center">
								...
								<img alt="Logo" src="../assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Continua con Google</a>
								<!--end::Google link-->
								<!--begin::Google link-->
								<a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
								<img alt="Logo" src="../assets/media/svg/brand-logos/facebook-4.svg" class="h-20px me-3" />Continua con Facebook</a>
								<!--end::Google link-->
								<!--begin::Google link-->
								<a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
								<img alt="Logo" src="../assets/media/svg/brand-logos/apple-black.svg" class="h-20px me-3" />Continua con Apple</a>
								<!--end::Google link-->
							</div>
							<!--end::Actions-->
						</form>
