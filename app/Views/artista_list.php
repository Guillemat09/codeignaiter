						...
						<div data-kt-search-element="wrapper">
							...
							<div data-kt-search-element="results" class="d-none">
								...
								<div class="scroll-y mh-200px mh-lg-350px">
									...
									<h3 class="fs-5 text-muted m-0 pb-5" data-kt-search-element="category-title">Usuario</h3>
									<!--end::Category title-->
									<!--begin::Item-->
...
<div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
				...
				<li class="breadcrumb-item text-dark">Artistas</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<!--end::Container-->
						...
						<div class="card-toolbar">
							...
							<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
								...
								<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
									...
									<div class="px-7 py-5" data-kt-user-table-filter="form">
										<form method="get" action="<?= base_url('artistas') ?>">
											...
											<!--begin::Input group-->
											<div class="mb-10">
												<label class="form-label fs-6 fw-bold">Nombre artista:</label>

												<input type="text" name="nombre" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="artista" value="<?= isset($filters['nombre']) ? esc($filters['nombre']) : '' ?>" />
											...
											<!--begin::Input group-->
											<div class="mb-10">
												<label class="form-label fs-6 fw-bold">Genero:</label>

												<input type="text" name="genero" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="genero" value="<?= isset($filters['genero']) ? esc($filters['genero']) : '' ?>" />
											...
											<!--begin::Actions-->
											<div class="d-flex justify-content-end">
												<a href=" <?= base_url("/artistas") ?>" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6">Resetear</a>
								...
								<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
									...
									<!--end::Svg Icon-->Añadir artista</button>
									<?php endif; ?>
								<!--end::Add user-->
							</div>
							<!--end::Toolbar-->
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										...
										<div class="modal-header" id="kt_modal_add_user_header">
											<!--begin::Modal title-->
											<h2 class="fw-bolder">Añadir artista</h2>
											<!--end::Modal title-->
											<!--begin::Close-->
											...
											<form id="kt_modal_add_user_form" class="form" action="<?= isset($artista) ? base_url('artistas/save/') . $artista['id'] : base_url('artistas/save') ?>" method="post" onsubmit="return validateForm()">
												...
												<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
													...
													<div class="fv-row mb-7">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="nombre" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="nombre del artista" value="" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<div class="fv-row mb-7">
													...
													<div class="fv-row mb-7">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="genero" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="genero" value="" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
								...
								<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
									...
									?>
										<th class="min-w-125px">
											<a href="<?= base_url('artistas') . '?' . http_build_query(array_merge($_GET, ['sort' => $col, 'order' => $new_order])) ?>">
												<?= $title ?>
									...
									<tr>
										...
										<td class="text-end">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="<?= base_url('artistas/save/' . $artista['id']) ?>" class="menu-link px-3">Editar</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
	...
	<!--end::Javascript-->
	<script>
		document.getElementById("busquedaArtista").addEventListener("keypress", function(event) {
			if (event.keyCode == 13) {
